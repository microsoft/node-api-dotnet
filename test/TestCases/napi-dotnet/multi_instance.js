...
if (isMainThread) {
  ...
  // not isolated. But .NET hosted modules do get reloaded in a worker, with isolated static data,
  // so the following assertions only pass for that type of module.
