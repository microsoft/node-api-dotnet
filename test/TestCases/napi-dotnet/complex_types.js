...
assert.deepStrictEqual(ComplexTypes.list, []);
assert.strictEqual(ComplexTypes.list.join(), '');
ComplexTypes.list.push(5, 6, 7);
assert.strictEqual(ComplexTypes.list.join(), '5,6,7');
ComplexTypes.list = [0, 1, 2];
assert.notStrictEqual(ComplexTypes.list, listValue);
assert.strictEqual(ComplexTypes.list[0], 0);
assert.deepStrictEqual(ComplexTypes.list, [0, 1, 2]);
assert.strictEqual(ComplexTypes.list.join(), '0,1,2');
...
mapValue.set(1, 'one');
assert.strictEqual(mapValue.get(1), 'one');
mapValue.set(2, 'two');
assert.strictEqual([...mapValue.entries()].join(';'), '1,one;2,two');
